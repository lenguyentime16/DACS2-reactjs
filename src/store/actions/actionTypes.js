const actionTypes = Object.freeze({
    ...
    //admin
    FETCH_GENDER_START: 'FETCH_GENDER_STAR',
    ...
    FETCH_TOP_TEACHER_FAILDED: 'FETCH_TOP_TEACHER_FAILDED',

    FETCH_ALL_TEACHER_SUCCESS: 'FETCH_ALL_TEACHER_SUCCESS',
    FETCH_ALL_TEACHER_FAILDED: 'FETCH_ALL_TEACHER_FAILDED',

    SAVE_DETAIL_TEACHER_SUCCESS: 'SAVE_DETAIL_TEACHER_SUCCESS',
    SAVE_DETAIL_TEACHER_FAILDED: 'SAVE_DETAIL_TEACHER_FAILDED',
    ...
    FETCH_REQUIRED_TEACHER_INFOR_FAILDED: 'FETCH_REQUIRED_TEACHER_INFOR_FAILDED',
})
